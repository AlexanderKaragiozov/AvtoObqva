...
urlpatterns = [
    ...
    path('listings/<int:pk>', views.ViewMyListings.as_view(), name='listings'),
    path('listings/<str:table>/<int:pk>/edit', views.UpdateListing.as_view(), name='edit_listing'),
    path('listings/<str:table>/<int:pk>/delete', views.DeleteListing.as_view(), name='delete_listing'),
